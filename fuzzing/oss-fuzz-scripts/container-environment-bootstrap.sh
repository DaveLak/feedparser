...
fetch_seed_data() {
    rsync -avc "$SRC/feedparser/fuzzing/dictionaries/" "$SEED_DATA_DIR/"
}
...
download_and_concatenate_common_dictionaries "$SEED_DATA_DIR/__base.dict" \
  "https://raw.githubusercontent.com/google/fuzzing/master/dictionaries/rss.dict" \
  "https://raw.githubusercontent.com/google/fuzzing/master/dictionaries/atom.dict" \
